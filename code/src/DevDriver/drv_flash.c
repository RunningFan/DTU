...
void sFLASH_LowLevel_Init(void)
{
        ...
        RCC_APB2PeriphClockCmd(sFLASH_CS_GPIO_CLK       | sFLASH_WP_GPIO_CLK       | sFLASH_BUSY_GPIO_CLK | 
                               sFLASH_SPI_MOSI_GPIO_CLK | sFLASH_SPI_MISO_GPIO_CLK | sFLASH_SPI_SCK_GPIO_CLK, ENABLE);
        ...
        /*!< Configure sFLASH_WP_PIN pin: sFLASH Card WP pin */
        GPIO_InitStructure.GPIO_Pin   = sFLASH_WP_PIN;
        GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
        GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_Out_PP;
        GPIO_Init(sFLASH_WP_GPIO_PORT, &GPIO_InitStructure);
        
        /*!< Configure sFLASH_BUSY_PIN pin: sFLASH Card BUSY pin */  
        GPIO_InitStructure.GPIO_Pin   = sFLASH_BUSY_PIN;
        GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
        GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_Out_PP;
        GPIO_Init(sFLASH_BUSY_GPIO_PORT, &GPIO_InitStructure);
        
        /*!< Disable Write Protect & Disable HOLD Function */
        GPIO_SetBits(sFLASH_WP_GPIO_PORT, sFLASH_WP_PIN | sFLASH_BUSY_PIN);
}
...
/**
* @brief  Erases the SubSector FLASH.
* @param  None
* @retval None
*/
...
{
//		/* judge NumByteToRead < 1k */
//		if(NumByteToRead > 1024){
//			return;
//		}
        /*!< Select the FLASH: Chip Select low */
        sFLASH_CS_LOW();
