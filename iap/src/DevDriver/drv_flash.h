/**
  ...
  * @version V4.5.0
  * @date    07-March-2011
  * @brief   This file contains all the functions prototypes for the drv_flash
  *          firmware driver.
  ******************************************************************************
  * @attention
  *
...
#define sFLASH_CMD_SSE            0x20  /*!< SubSector Erase instruction */
...
#define sFLASH_WP_PIN                    GPIO_Pin_5                  /* PC.05 */
#define sFLASH_WP_GPIO_PORT              GPIOC                       /* GPIOC */
#define sFLASH_WP_GPIO_CLK               RCC_APB2Periph_GPIOC  

#define sFLASH_BUSY_PIN                  GPIO_Pin_4                  /* PC.04 */
#define sFLASH_BUSY_GPIO_PORT            GPIOC                       /* GPIOC */
#define sFLASH_BUSY_GPIO_CLK             RCC_APB2Periph_GPIOC  
...
/** @defgroup drv_FLASH_Exported_Macros
  * @{
  */
/**
...
/** @defgroup drv_FLASH_Exported_Functions
  * @{
  */
/**
